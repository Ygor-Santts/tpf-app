...
export const useTaxonomyStore = defineStore('taxonomy', {
  state: () => ({ categories: [] as JobCategory[], states: [] as State[], citiesByState: {} as Record<string, City[]>, occupationsByCategory: {} as Record<number, JobOccupation[]>, loading: false, error: null as string | null }),
  actions: {
