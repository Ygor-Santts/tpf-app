...
async function onCategoryChange() {
  if (form.jobCategoryId) {
    ...
    await tax.loadOccupations(form.jobCategoryId)
  }
}
...
const canSubmit = computed(
  () =>
    ...
    form.password &&
    form.phone &&
    form.jobOccupationIds.length > 0 &&
    form.operationCitiesIds.length > 0
)
...
<template>
  <div class="grid gap-4">
    ...
    <div class="grid gap-1">
      ...
      <select
        v-model.number="form.jobCategoryId"
    ...
    <div v-if="form.jobCategoryId" class="grid gap-1">
      ...
      <p v-if="form.jobOccupationIds.length === 0" class="text-xs text-red-600">
        Selecione ao menos uma ocupação.
      </p>
    </div>
    <div class="grid gap-1">
    ...
    <div v-if="form.stateCode" class="grid gap-1">
      ...
      <p v-if="form.operationCitiesIds.length === 0" class="text-xs text-red-600">
    ...
    <button
      ...
      @click="submit"
      class="rounded-xl p-3 bg-black text-white"
